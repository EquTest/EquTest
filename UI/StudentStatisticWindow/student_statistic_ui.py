...
class StatisticUI(QtWidgets.QMainWindow):
    def __init__(self, add_student_names: bool = False):
        super().__init__()
    ...
    def setupUi(self, StudentStatistic):
        ...
        if self.__add_student_names__:
            self.student_name = QtWidgets.QLabel(self.background)
            self.student_name.setGeometry(QtCore.QRect(90, 130, 200, 31))
